...
# Description:
# This script demonstrates non-convergence issues in logistic
# regression, including perfect separation.
############################################################
...
# - Coefficients may diverge to infinity
...
# - Logistic regression may fail when the data is perfectly separable
# - Non-convergence indicates instability in parameter estimates
# - This is important in classification modeling
